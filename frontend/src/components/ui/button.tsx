  ...
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-lg text-sm font-semibold ring-offset-background transition-all focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-5 [&_svg]:shrink-0 active:scale-[0.98]",
  {
    variants: {
      variant: {
        ...
        // Pharmadix custom variants
        success: "bg-success text-success-foreground hover:bg-success/90 shadow-sm",
        warning: "bg-warning text-warning-foreground hover:bg-warning/90 shadow-sm",
        info: "bg-info text-info-foreground hover:bg-info/90 shadow-sm",
        entry: "bg-success text-success-foreground hover:bg-success/90 shadow-md text-lg font-bold",
        exit: "bg-warning text-warning-foreground hover:bg-warning/90 shadow-md text-lg font-bold",
      },
      size: {
        ...
        icon: "h-10 w-10",
        touch: "min-h-[48px] px-6 py-3 text-base",
        action: "min-h-[64px] px-8 py-4 text-xl rounded-xl",
      },
    },
    defaultVariants: {
      variant: "default",
